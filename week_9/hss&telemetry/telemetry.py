...
def get_hss(session: requests.Session, base_url: str):
...
def get_qr(session: requests.Session, base_url: str):
...
def send_telemetry(
    ...
    print("TELEMETRY STATUS:", r.status_code, "| RESP:", r.text)
    return r
